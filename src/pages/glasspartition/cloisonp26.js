            ...
            <Container>
              ...
              background: black;
                            ...
                            <Col>
                                ...
                                <Bounce direction={"right"} triggerOnce={true}>
                                    <div className="m-5">
                                        <Button className="btdw p-2" onClick={() => { window.open("https://drive.google.com/file/d/1fqTFgPPnhx9oUAlNFWm00ppzBb-qLxUM/view?usp=drive_link", '_blank') }}>Download</Button>
                                    </div>
                                </Bounce>
                            </Col>
                        </Row>
