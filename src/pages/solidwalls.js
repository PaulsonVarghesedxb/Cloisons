                        ...
                        <Row className='m-5 p-5 '>
                            <Col md="12" className='px-3' >
                                <Bounce direction={"left"} triggerOnce={true}>
                                    ...
                                    <p>Choose from manually operated single or hinged paired panels, or automate your set-up with continuously hinged, electric operation, Kwik-Wall Operable Walls are available with ADA inset pass doors, storage pocket door closures, and a myriad of standard or custom panel finishes, limited only by your imagination.</p>
